...
describe("Geocode API Logic", () => {
  ...
  it("makes request to census.gov with correct URL encoding", async () => {
    ...
    const expectedUrl =
      "https://geocoding.geo.census.gov/geocoder/locations/onelineaddress?address=123%20Main%20St%20%26%20Oak%20Ave%2C%20New%20York%2C%20NY&benchmark=Public_AR_Current&format=json";
  ...
  it("handles special characters in address", async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      expect.stringContaining(
        "123%20Main%20St%20%234B%2C%20New%20York%2C%20NY%2010001"
      )
    );
  });
