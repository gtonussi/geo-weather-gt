...
describe('WeatherCard', () => {
  ...
  it('displays short forecast by default', () => {
    ...
    expect(screen.getByText('Sunny')).toBeInTheDocument()
    expect(screen.queryByText('Sunny skies with light winds. High near 75F.')).not.toBeInTheDocument()
  })
  ...
  it('toggles to detailed forecast when clicked', async () => {
    ...
    expect(screen.getByText('Sunny skies with light winds. High near 75F.')).toBeInTheDocument()
  })
  ...
  it('displays correct expand/collapse icons', async () => {
    ...
    expect(screen.queryByLabelText('Expand for details')).not.toBeInTheDocument()
  ...
  it('renders weather icon with correct attributes', () => {
    ...
    expect(image).toHaveAttribute('src', 'https://api.weather.gov/icons/land/day/clear?size=medium')
